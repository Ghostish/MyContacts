 ...
 */
public class ShowBlockedNumbersActivity extends AppCompatActivity implements EditTextDialogFragment.onEditDialogButtonClickListener, ConfirmDialogFragment.onConfirmDialogButtonClickListener {
    ...
    private void showEditDialog(String number) {
        ...
        mEditDialog.setEditText(number);
